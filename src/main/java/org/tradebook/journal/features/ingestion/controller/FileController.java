...
public class FileController {
        ...
        public ResponseEntity<DataApiResponse<FileUploadResponse>> uploadFile(
                        @io.swagger.v3.oas.annotations.Parameter(description = "Metadata for the file", content = @io.swagger.v3.oas.annotations.media.Content(mediaType = MediaType.APPLICATION_JSON_VALUE)) @RequestPart("file-metadata") FileUploadRequest fileRequest,
